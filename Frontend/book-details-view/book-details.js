...
<div class="book-details-page">
    ...
    <div class="book-details-section">
        ...
        <div style="margin-top: 3%; display:flex; gap: 2%" > <p class="book-title">The Great Gatsby</p><div class="price"> 300 EGP</div>  <button> Add to Cart</button> <button class="fav"> <i class="fa-regular fa-heart"></i></button></div>
         <div style="margin-top: 0%;display: flex;"> <p style="text-align: left; ">Author: </p> <p style=" margin-left: 2px">F. Scott Fitzgerald</p></div> 
         <div style="margin-top: 0%;display: flex;"> <p style="text-align: left; ">Genre: </p> <p style=" margin-left: 2px">Classic Fiction, Literary Fiction</p></div> 
         <div style="margin-top: 0%;display: flex;"> <p style="text-align: left; ">Published: </p> <p style=" margin-left: 2px">1925</p></div> 
         <div style="margin-top: 0%;display: flex;"> <p style="text-align: left; ">Language: </p> <p style=" margin-left: 2px">English</p></div> 
         <div style="margin-top: 0%;display: flex;"> <p style="text-align: left; ">Pages: </p> <p style=" margin-left: 2px">180</p></div> 
         <div style="margin-top: 0%;display: flex;"> <p style="text-align: left; ">ISBN: </p> <p style=" margin-left: 2px">978-0743273565</p></div> 
         <div style="margin-top: 0%;display: flex;"> <p style="text-align: left; ">Publisher: </p> <p style=" margin-left: 2px">Charles Scribner’s Sons</p></div> 
